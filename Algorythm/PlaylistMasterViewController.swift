...
//  Copyright (c) 2015 Lucas Ochoa. All rights reserved./Users/Lucasochoa/Google Drive/Algorythm/Algorythm/PlaylistMasterViewController.swift
//
...
class PlaylistMasterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for thisOne in playlistsArray{
            thisOne.layer.cornerRadius = 85.0
        }// yay i can sortoff code^
